...
@section('content')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-9">
                ...
                <div class="lg:pl-[100px] flex items-center">
                    <div class="data w-full">
                        <h2
                            class="font-manrope font-bold text-4xl lg:text-5xl text-white mb-9 max-lg:text-center relative">
                            À propos de nous</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-9">
                <div class="lg:pr-24 flex items-center">
                    <div class="data w-full">
                        ...
                        <h2 class="font-manrope font-bold text-4xl lg:text-5xl text-white mb-9 max-lg:text-center">Créatifs depuis 2005</h2>
                        <p class="font-normal text-xl leading-8 text-gray-200 max-lg:text-center max-w-2xl mx-auto">
    ...
    <section class="py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 class="font-manrope text-4xl text-center text-gray-200 font-bold mb-14">Nos résultats en chiffres</h2>
            <div class="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-black font-semibold mb-2">Croissance de l'entreprise</h4>
                            <p class="text-xs text-gray-200 leading-5">Suivez le remarquable parcours de croissance de notre entreprise alors que nous continuons d'innover et de viser toujours plus haut.
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-black font-semibold mb-2">Membres de l'équipe</h4>
                            <p class="text-xs text-gray-200 leading-5">Nos membres talentueux sont le moteur de Pagedone et les piliers de notre succès.</p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-black font-semibold mb-2">Projets réalisés</h4>
                            <p class="text-xs text-gray-200 leading-5">Nous avons mené à bien plus de 625 projets à travers le monde et notre compteur ne cesse de s'accroître.</p>
                        </div>
                    </div>
                </div>
            </div>
