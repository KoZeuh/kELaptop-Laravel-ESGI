...
@section('content')
    ...
    <section class="py-20 bg-white">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 class="font-manrope text-4xl text-center text-gray-900 font-bold mb-14">Nos résultats en chiffres</h2>
            <div class="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-gray-900 font-semibold mb-2">Croissance de l'entreprise</h4>
                            <p class="text-xs text-gray-500 leading-5">Suivez le remarquable parcours de croissance de notre entreprise alors que nous continuons d'innover et de viser toujours plus haut.
                            </p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-gray-900 font-semibold mb-2">Membres de l'équipe</h4>
                            <p class="text-xs text-gray-500 leading-5">Nos membres talentueux sont le moteur de Pagedone et les piliers de notre succès.</p>
                        </div>
                    </div>
                </div>
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-gray-900 font-semibold mb-2">Projets réalisés</h4>
                            <p class="text-xs text-gray-500 leading-5">Nous avons mené à bien plus de 625 projets à travers le monde et notre compteur ne cesse de s'accroître.</p>
                        </div>
                    </div>
                </div>
            </div>
