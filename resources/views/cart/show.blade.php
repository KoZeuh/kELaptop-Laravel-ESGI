            ...
            <div class="relative">
                <ul class="relative flex w-full items-center justify-between space-x-2 sm:space-x-4">
                    <li class="flex items-center space-x-3 text-left sm:space-x-4">
                        <a class="flex h-6 w-6 items-center justify-center rounded-full bg-gray-600 text-xs font-semibold text-gray-200 ring ring-gray-600 ring-offset-2" href="#">1</a>
                ...
                @if (!$currentUser->cartItems->isEmpty())
                    ...
                    <form action="{{route('cart.checkCoupon')}}" method="POST">
                        ...
                        <div class="flex my-3">
                            ...
                            <button class="w-1/4 rounded-md bg-gray-900 px-6 py-3 font-medium text-gray-200">Appliquer</button>
                        </div>
                    </form>
                @endif
            </div>
                ...
                <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
                    ...
                    <div class="">
                        @if (!$currentUser->cartItems->isEmpty())
                            ...
                            <div class="relative">
                                <input required type="text" id="email" name="email" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="{{$currentUser->email}}" />
                            ...
                            <div class="flex">
                                <div class="relative w-7/12 flex-shrink-0">
                                    <input required type="text" id="firstname" name="firstname" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="{{$currentUser->firstname}}" />
                                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                ...
                                <input required type="text" id="lastname" name="lastname" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="{{$currentUser->lastname}}" />
                            ...
                            <div class="relative">
                                <input required type="text" id="phone" name="phone" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="{{$currentUser->phone}}" />
                                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <div class="relative">
                                <input required type="text" id="card-identity" name="card-identity" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" value="{{$currentUser->firstname}} {{$currentUser->lastname}}" />
                                <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <div class="flex">
                                <div class="relative w-7/12 flex-shrink-0">
                                    <input required type="text" id="card-number" name="card-number" class="w-full rounded-md border border-gray-200 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="xxxx-xxxx-xxxx-xxxx" />
                                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                        <svg class="h-4 w-4 text-gray-200" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                                        <path d="M11 5.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1-.5-.5v-1z" />
                                        <path d="M2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2zm13 2v5H1V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1zm-1 9H2a1 1 0 0 1-1-1v-1h14v1a1 1 0 0 1-1 1z" />
                                ...
                                <input required type="text" name="card-expiry" class="w-full rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="MM/YY" />
                                <input required type="text" name="card-cvc" class="w-1/6 flex-shrink-0 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="CVC" />
                            </div>

                            <label for="billing-address" class="mt-4 mb-2 block text-sm font-medium">Adresse de facturation</label>
                            <div class="flex flex-col sm:flex-row">
                                <div class="relative flex-shrink-0 sm:w-7/12">
                                    <input required type="text" id="billing-address" name="billing-address" value="{{$currentUser->address}}" class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Street Address" />
                                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                                        <img class="h-4 w-4 object-contain" src="https://flagpack.xyz/_nuxt/4c829b6c0131de7162790d2f897a90fd.svg"/>
                                    </div>
                                </div>

                                <input required value="{{$currentUser->zip}}" type="text" name="billing-zip" class="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="ZIP" />
                                <input required value="{{$currentUser->city}}" type="text" name="billing-city" class="flex-shrink-0 rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none sm:w-1/6 focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="City" />
                            </div>

                            <label for="billing-country" class="mt-4 mb-2 block text-sm font-medium">Pays</label>
                            <input required value="{{$currentUser->country}}" type="text" name="billing-country" class="w-full rounded-md border border-gray-200 px-4 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500" placeholder="Country" />
                        @endif
                        ...
                        <div class="mt-6 border-t border-b py-2">
                            <div class="flex items-center justify-between">
                                ...
                                <p class="font-semibold">{{ $cartTotalAmount}} $</p>
                            </div>
                            ...
                            @if ($amountWithDiscount > 0)
                                <div class="flex items-center justify-between">
                                    <p class="text-sm font-medium">Réduction ({{$promoDiscount}} %) (Code : <u>{{$promoCode}})</p>
                                    <p class="font-semibold"></u>{{$amountWithDiscount}} $ - <button type="button" onclick="window.location.href='/cart/removeCoupon'"><i class="fa-solid fa-trash text-red-500"></i></button></p>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <p class="text-2xl font-semibold">{{$cartTotalAmount - ($cartTotalAmount * $promoDiscount / 100)}} $</p>
                        </div>
                    </div>

                    @if (!$currentUser->cartItems->isEmpty())
                        <button type="submit" class="mt-4 mb-8 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-gray-200">Passer commande</button>
                    @endif
                </div>
            </form>
    </div>
